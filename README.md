...
>
> 📋 属于 [三仓库生态系统](https://github.com/zhangdashuai968/morning-newspaper/blob/master/WORKFLOW.md) 的学习路线仓库
...
| 目录 | 用途 | 状态 |
|---|---|---|
| [PROGRESS.md](PROGRESS.md) | 📊 35 个实验/任务的实时进度追踪，每日早报联动 | ✅ 已就绪 |
| `roadmap.md` | 6 阶段总路线图，每阶段目标 / 产出 / 验收 | ✅ 已就绪 |
| `parallel/` | 独立子任务 spec + 学习笔记 | ✅ 27 个文件 |
| `notes/` | 教材精读 / 概念梳理笔记 | 3 篇 (E01-E03) |
| `logs/` | 调试 / 跑通 / 调优日志（按日期） | 待填充 |
| `cheatsheets/` | 速查表（启动链路 / 标定参数 / TF tree / launch 索引） | 雏形已建 |

## 当前位置

进度追踪已迁移至 👉 [PROGRESS.md](PROGRESS.md) — 每日早报同步显示
...
👉 [small-car](https://github.com/zhangdashuai968/small-car) — ABOT M1 ARM 小车真机 ROS 工作区，包含 LIDAR、深度相机、IMU 融合定位、机械臂控制、航线巡逻、视觉抓取等完整工程实现。
...
- **[morning-newspaper](https://github.com/zhangdashuai968/morning-newspaper)**（每日早报）：进度数据源，每天早上邮件推送最新学习进度。详见 [WORKFLOW.md](https://github.com/zhangdashuai968/morning-newspaper/blob/master/WORKFLOW.md)
